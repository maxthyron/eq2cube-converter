...
void get_files(std::string dirPath, std::vector<std::string>& files) {
	DIR* dir;
	dirent* pdir;
...
int main(int argc, char** argv) {
	...
	std::string path = "C:\\Users\\User\\Desktop\\Converter\\Converter\\x64\\Release\\images";
	std::string outputDir = "C:\\Users\\User\\Desktop\\Converter\\Converter\\x64\\Release\\output";
	cv::Mat* result;
